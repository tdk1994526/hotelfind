...
- (void)viewDidLoad
{
    ...
    if (keyboardToolbar == nil) {
        ...
        UIBarButtonItem *previousButton = [[UIBarButtonItem alloc] initWithTitle:@"上一个" style:UIBarButtonItemStyleBordered target:self
...
- (UITableViewCell *)tableView:(UITableView *)tableView cellForRowAtIndexPath:(NSIndexPath *)indexPath {
    ...
    if (indexPath.row == 0) {
        ...
        [cell.textFieldCell setPlaceholder:@"入住日期"];
        ...
        cell.textFieldCell.inputView = datePicker;
        cell.textFieldCell.inputAccessoryView = keyboardToolbar;
        [cell.textFieldCell setPlaceholder:@"离开日期"];
    }
    
    else if (indexPath.row == 2){
        cell.textFieldCell.inputView = pickerView;
        cell.textFieldCell.inputAccessoryView = keyboardToolbar;
        [cell.textFieldCell setPlaceholder:@"人数"];
    }
    else {
        cell.textFieldCell.inputView = pickerView;
        cell.textFieldCell.inputAccessoryView = keyboardToolbar;
        [cell.textFieldCell setPlaceholder:@"房间类型"];
    }
